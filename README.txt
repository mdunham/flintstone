Thanks for purchasing Flintstone. Flintstone is here to help you with your next project. If you have any questions that are beyond the scope of this help file, please feel free to contact us at contact@hencework.com



Flintstone is an advanced, responsive dashboard UI kit built using Bootstrap, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.
...
If everything was installed correctly, you should see the jQuery version of Flintstone running in http://localhost:9000/
